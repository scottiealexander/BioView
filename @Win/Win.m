...
%
% Out:
%       win - an instance of the Win class
%
% Example:
%       %this is a very simple example
%       %see Win.Test for a more complete one
%
...
%           };
%       win = Win(c,'title','Title','focus','input','grid',false);
            ...
            for kC = 1:max(self.ncol)                
                ...
                if ~isempty(self.content{kR,kC})
                    if el_init
                        ...
                        self.el{kR,kC} = Element(self,pos,self.content{kR,kC},'halign',halign);
